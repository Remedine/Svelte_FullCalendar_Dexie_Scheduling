...
<div class="user-management">
	<header class="user-management__header">
		...
		<div style="display: flex; gap: 0.5rem;">
			...
			<button onclick={refreshRoster} class="user-management__add-btn" style="background: #2196f3;"
				>Refresh roster from server</button
			>
		</div>
	</header>
		...
		{#each allUsers as user (user.id)}
			<div class="user-management__row">
				...
				<div class="user-management__actions-col">
					...
					>
					<button
						onclick={() => openEmailLink(user)}
						class="user-management__btn user-management__btn--email"
					>
			...
			>
				...
				<div class="modal__actions">
					...
					<button
						...
						class="modal__btn modal__btn--delete">Delete User</button
					>
					<button
						onclick={() => {
							showEditModal = false;
						...
						class="modal__btn modal__btn--cancel">Cancel</button
					>
			...
			>
				...
				<div class="modal__actions">
					<button
						...
						class="modal__btn modal__btn--cancel">Cancel</button
					>
					<button onclick={saveEmailLink} class="modal__btn modal__btn--save"
						>Save & Link Email</button
					>
				</div>
			</div>
		</div>
